...
const BottomNavigation = ({
  ...
  const safeAreaInsetsHook = useSafeAreaInsets();
  ...
  const { dark: isDarkTheme, mode } = theme;
  ...
  const approxBackgroundColor = customBackground
    ...
    ? overlay(elevation, theme.colors.bg.canvas)
  ...
  const insets = {
    ...
    bottom: safeAreaInsets?.bottom ?? safeAreaInsetsHook.bottom,
  };
        ...
        >
          ...
          >
            ...
            {routes.map((route, index) => {
              ...
              const activeLabelColor = activeTintColor;

              const inactiveLabelColor = inactiveTintColor;
              ...
              const isV3Shifting = shifting && labeled;
